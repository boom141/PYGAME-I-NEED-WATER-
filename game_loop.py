...
def level_transition(odd_slider,even_slider):
	for i in range(5):
		if i % 2 != 0:
			pygame.draw.rect(window, ((25,25,25)),((odd_slider,i*100,500,100)))
		else:
			pygame.draw.rect(window, ((25,25,25)),((even_slider,i*100,500,100)))
...
def game_loop():
	...
	# fill the screen --------------------------------------------------------#  
		...
		if even_slider < -WINDOW_SIZE[0] and odd_slider > WINDOW_SIZE[0]:
			game = True
	...
	# map edeges ------------------------------------------------------------#
		...
		if game_data.true_scroll[0] < 355:
			game_data.true_scroll[0] = 355
	...
	# render meter --------------------------------------------------------------#
		...
		odd_slider += 15 * delta_time
		even_slider -= 15 * delta_time
		...
		level_transition(odd_slider,even_slider)
